...
namespace WindowsFormsApp2
{
    public partial class Form2 : Form
    {
        ...
        private void procesar()
        {
            ...
            while ((line = file.ReadLine()) != null)
            {
                ...
                if ((mail != mailAux) || (razonsocial != razonsocialAux))// || (cuit != cuitAux))
                {
                    ...
                    //acá se suma uno mas y se diferencian los mails de prueba. 
                    ...
                    if (cantidadMailIgual == 0)
                    {
                        ...
                        mailLinea = string.Format("{0}|", MailEnviadoA());

                    }
                    else
                    {
                        mailLinea = string.Format("{0}+{1}|", MailEnviadoA(), cantidadMailIgual.ToString());
                    }
                ...
                case "C":
                    {
                        ...
                        QRContenido = "https://app.test.arba.gov.ar/PagoQR/imagen?data=:https://cdni.h.redlink.com.ar/linkarba.html?prod=cdniarba&ente=" + Ente + "&rubro=" + Rubro + "&cpe=" + codigoElectronico + "&crc=XXXX";
        ...
        public string MailEnviadoA()
        {
            ...
            if (Prueba.Checked)
            {
                string[] Mails = new string[] { "oscar.avendano@arba.gov.ar;", "cecilia.cerda@arba.gov.ar;", "nicol.cruz@arba.gov.ar;", "lilian.sayago@arba.gov.ar>;", "marcelo.maranino@arba.gov.ar;", "mario.lestani@arba.gov.ar;", "omar.panella @arba.gov.ar;", "patricia.feo @arba.gov.ar;", "rodolfo.sosarainone@arba.gov.ar;", "romina.montenegro@arba.gov.ar;", "natalia.vacun@arba.gob.ar" };
